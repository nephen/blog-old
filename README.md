...
This is a tutorial on my blog which based on Jekyll Clean, I've added some new features to this foundation, and welcome to continue to improve on this basis, You can find more information about me on the my web site of about. And the next section is about the Jekyll Clean theme.

* Get it from [github](https://github.com/nephen/nephen.github.io).
* See the [live demo](www.nephen.com).

If you want to join in to build your own blog, just refer to the following tutorial.
